...
void geo::DatumConvert(int dIn, double LatIn, double LongIn, double HtIn, int dTo,  double& LatTo, double& LongTo, double& HtTo)
{
...
void geo::LLtoUTM(double Lat, double Long,  double& Northing, double& Easting, int& Zone, int eId)
{
...
void geo::UTMtoLL(double Northing, double Easting, int Zone,  double& Lat, double& Long, int eId)
{
