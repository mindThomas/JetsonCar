...
pcl::visualization::PCLVisualizer::Ptr simpleVis (pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud)
{
  ...
  // --------------------------------------------
  pcl::visualization::PCLVisualizer::Ptr viewer (new pcl::visualization::PCLVisualizer ("3D Viewer", false));
...
{
  QApplication VisualizerApp(argc, argv);
  QTPCLVisualizer visualizer;
  ...
  visualizer.SetViewer(viewer.get());
  visualizer.show();

  return VisualizerApp.exec();
