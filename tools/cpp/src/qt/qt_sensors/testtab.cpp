    ...
    ui(new Ui::TestTab)
{
    ...
    ui->imu3Dview->setMinimumWidth(200);
    ui->imu3Dview->setRollPitchYaw(20, 20, 0);
    ui->imu3Dview->setSizePolicy(QSizePolicy::MinimumExpanding, QSizePolicy::MinimumExpanding);
...
{
   ui->imu3Dview->setRollPitchYaw(ui->roll->value(), ui->pitch->value(), ui->yaw->value());
}
