...
IMUExtrinsicCalibrator::IMUExtrinsicCalibrator(bool estimate_misalignment, bool estimate_frame_correction)
...
IMUExtrinsicCalibrator::~IMUExtrinsicCalibrator()
{
}
...
void IMUExtrinsicCalibrator::AddMeasurement(const gtsam::Rot3& R_imu_measurement, const gtsam::Rot3& R_realsense_measurement)
{
...
gtsam::Values IMUExtrinsicCalibrator::Dogleg_Optimize()
{
...
gtsam::Values IMUExtrinsicCalibrator::LM_Optimize()
{
    gtsam::Values estimate;
...
gtsam::Values IMUExtrinsicCalibrator::GN_Optimize()
{
    gtsam::Values estimate;
...
gtsam::Values IMUExtrinsicCalibrator::ISAM2_Optimize()
{
